...
| Параметр | Значение |
|-----------|---------|
| Желаемая должность | QA Engineer, CA Engineer, Software Tester |
| Желаемый уровень зарплаты | от 60 000 ₽ |
...
**ВНИИ АНО ЦМИ — Тестировщик ПО**  
_Декабрь 2025 — Январь 2026_

**Обязанности:**  
- Проведение функционального тестирования ПО  
- Разработка тест-кейсов, чек-листов, отчётов о тестировании  
- Заведение и сопровождение дефектов в баг-трекинговой системе  
- Взаимодействие с разработчиками и аналитиками  
- Участие в проверке требований  

**Результаты:**  
- Выявлено 2 критических дефекта, влияющих на безопасность системы  
- Повышено качество и надёжность продукта  
...
| СПбГИЭУ «ИНЖЭКОН» | 2004 — 2007 | Коммерция (неоконченное высшее) |
| Радиотехнический профессиональный лицей №1 | 1999 — 2003 | слесарь-механик РЭАиПр (5 разряд), слесарь-сборщик РЭАиПр (5 разряд) |

---

## 4. Основные навыки и знания
...
- **Java**: [GitHub](https://github.com/Yvagaemiy/-2.-Java.git)  
- **C#**: [GitHub](https://github.com/Yvagaemiy/Stydi-05.05.23.git)
...
### Тестирование
- Понимание целей и задач тестирования ПО  
- Создание чек-листов для проверки функциональности  
- Разработка тест-кейсов с указанием входных данных, шагов, ожидаемого результата и тестового окружения  
- Составление баг-репортов с подробным описанием шагов воспроизведения и приложением скриншотов  
- Регрессионное тестирование: проверка корректности работы старой функциональности после внесения изменений  

#### Тест-дизайн
- Применение техник: анализ граничных значений, эквивалентное разделение  
- [Итоговая работа в Google-таблице](https://drive.google.com/drive/folders/1lnuqJD3wejAikoiGjT6NhMsMaC7jNc71?usp=drive_link)

#### Автоматизированное тестирование UI
- Базовые знания Selenium для автоматизации рутинных задач  
- [Ссылка на GitHub](https://github.com/Yvagaemiy/Slelenium_Stepik.git)

#### Тестирование API
- Проверка взаимодействия между компонентами системы с использованием Postman  
- [Ссылка на Google-таблицу](https://drive.google.com/drive/folders/171OfU__prc3nDwfVRXAadOGYObhOQsqE?usp=drive_link)

#### UI-тестирование
- Проверка внешнего вида, удобства использования и соответствия макетам
